...
routes.get("/orders", (req, res) => {
  res.render("orders", { activePage: 'orders' });
});

// Serve takeorders.ejs at the /takeorders route
routes.get("/takeorders", (req, res) => {
  res.render("takeorders", { activePage: 'takeorders' });
});

// Serve inventory.ejs at the /suppliers route
routes.get("/inventory", (req, res) => {
  res.render("inventory", { activePage: 'inventory' });
});

// Serve supplier.ejs at the /suppliers route
routes.get("/supplier", (req, res) => {
  res.render("supplier", { activePage: 'supplier' });
});
...
routes.get("/categories", async (req, res) => {
  try {
    ...
    res.render("categories", { categories, activePage: 'categories' }); // Pass categories and activePage to the view
  } catch (error) {
...
// Serve bundleslist.ejs at the /bundles route
routes.get("/bundleslist", (req, res) => {
  res.render("bundleslist", { activePage: 'bundleslist' });
});

// Serve addbundles.ejs at the /bundles route
routes.get("/addbundle", (req, res) => {
  res.render("addbundle", { activePage: 'addbundle' });
});

// Serve editBundles.ejs at the /bundles route
routes.get("/editBundle", (req, res) => {
  res.render("editBundle", { activePage: 'editBundle' });
});

// Serve dashboard.ejs after successful login
routes.get("/salereport", (req, res) => {
  res.render("salereport", { activePage: 'salereport' });
});
